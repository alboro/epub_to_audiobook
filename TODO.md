...
- изучить всё тут /Users/aldem/Documents/ObsidianVaults/ideas/mcp чтобы научиться гуглить и другим навыкам
- используя гугление и другие навыки, добавить в этот файл таблицу: какой форк, какие фичи добавил -- чтобы решить, что импортировать к нам, а что из todo-пунктов взять из других форков, например, там добавлена Qwen3 TTS support: https://github.com/p0n1/epub_to_audiobook/compare/main...7enChan:reson:main которая нам тоже нужна!
